...
(null   , 'ativo' ,  '20' , 'DHT11'),
(null , 'inativo' , '30' , 'DHT11'),
(null ,   'ativo' , '15' , 'DHT11'),
(null ,   'ativo' , '45' , 'DHT11'),
(null , 'inativo' , '10' , 'DHT11');
...
(null ,  '2021/07/15  18:04:20' , 'DHT11' , 'setor B' , '40' , '30'),
(null  , null , 'DHT11' , 'setor C' , null , null),
(null  , '2021/06/03  12:09:16' , 'DHT11' , 'setor D' , '20' , '10'),
(null  , null , 'DHT11' , 'setor D' , null , null );
...
select Cliente.Nome , Cliente.telefone, Cliente.email, Cliente.senha, 
 ...
 sensor.idsensor, 
sensor.qtdSensores,  sensor.status_sensor,  historico.idHistorico, Historico.Data_Hora, Historico.Tipo_do_sensor, historico.Localizacao,
 historico.Valor_da_Temperatura , historico.Valor_da_Umidade
 from Cliente join Fazenda on fkcliente = idcliente  join Sensor on fkfazenda = idfazenda  join historico on fksensor = idsensor;
...
SELECT Cliente.Nome , Cliente.telefone,  Cliente.senha, 
 fazenda.idFazenda, fazenda.Cep, fazenda.Logradouro, fazenda.Cidade, fazenda.Estado,
 sensor.idsensor,   
 sensor.status_sensor, sensor.qtdSensores, historico.idHistorico, Historico.Data_Hora, historico.Valor_da_Temperatura , historico.Valor_da_Umidade,
 Historico.Tipo_do_sensor, historico.Localizacao ,email, subString_index(email, '@', -1) as domínio FROM Cliente join Sensor join Fazenda join historico
 on fkfazenda = idfazenda and fkcliente = idcliente and fksensor = idsensor;

select sum(idhistorico), count(idhistorico) from historico;
...
insert into Fazenda values
(null , '078262365' , ' Fazendas Cultivo', 'São Paulo' , 'SP' , null );
update Fazenda set fkcliente = 6 where idfazenda = 6;

insert into sensor values
(null  , 'ativo' ,  '24' , 'DHT11' , null);
update sensor set fkfazenda = 6 where idsensor = 6;

insert into historico values
(null ,  '2021/02/03  13:45:10' , 'DHT11' , 'setor E' , '24' , '33' , null);
  update Historico set fksensor = 6 where idhistorico = 6;

select 
Cliente.Nome , Cliente.telefone, Cliente.email, Cliente.senha, 
 fazenda.idFazenda, fazenda.Cep, fazenda.Logradouro, fazenda.Cidade, fazenda.Estado,
 sensor.idsensor, 
 sensor.status_sensor, sensor.qtdSensores,
 historico.idHistorico, Historico.Data_Hora, Historico.Tipo_do_sensor, historico.Localizacao, Historico.Data_Hora, 
 historico.Valor_da_Temperatura , historico.Valor_da_Umidade
